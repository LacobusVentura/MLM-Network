/*!
	\file NetworkEventHistoryWriterJSON.cpp
	\brief Network Event History Writer Object Implementation (JSON Format)
...
#include "NetworkEventHistoryWriterJSON.hpp"

namespace MLM
{

	NetworkEventHistoryWriterJSON::NetworkEventHistoryWriterJSON( std::ostream& os ) :
		m_ostream( os )
	{
	}


	NetworkEventHistoryWriterJSON::~NetworkEventHistoryWriterJSON( void )
	{
	}


	void NetworkEventHistoryWriterJSON::writeObject( const Serializable * s )
	{
...
/* $Id: NetworkEventHistoryWriterJSON.cpp 447 2017-05-05 10:52:07Z tiago.ventura $ */
